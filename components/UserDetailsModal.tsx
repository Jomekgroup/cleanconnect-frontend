            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto transform transition-all">
                <div className="p-6 sticky top-0 bg-white border-b z-10">
                    ...
                    <div className="flex items-center space-x-4">
                        <img className="h-16 w-16 rounded-full object-cover" src={user.profilePhoto instanceof File ? URL.createObjectURL(user.profilePhoto) : 'https://avatar.iran.liara.run/public'} alt="Profile"/>
                        <div>
