...
import { FacebookIcon, TwitterIcon, InstagramIcon, SparklesIcon } from './icons';
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="mt-12 border-t pt-8 flex flex-col sm:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-6 mt-4 sm:mt-0">
                       <a onClick={(e) => e.preventDefault()} className="text-gray-400 cursor-not-allowed"><span className="sr-only">Facebook</span><FacebookIcon className="h-6 w-6" /></a>
                       <a onClick={(e) => e.preventDefault()} className="text-gray-400 cursor-not-allowed"><span className="sr-only">Instagram</span><InstagramIcon className="h-6 w-6" /></a>
                       <a onClick={(e) => e.preventDefault()} className="text-gray-400 cursor-not-allowed"><span className="sr-only">Twitter</span><TwitterIcon className="h-6 w-6" /></a>
                    </div>
                </div>
            </div>
        </footer>
